...
import com.swemel.sevenzip.compression.lz.OutWindow;
import com.swemel.sevenzip.compression.rangecoder.BitTreeDecoder;
...
class Decoder {
    class LenDecoder {
        ...
        public void init() {
            com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_Choice);
        ...
        public int decode(com.swemel.sevenzip.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException {
    ...
    class LiteralDecoder {
        class Decoder2 {
            ...
            public void init() {
                com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_Decoders);
            }

            public byte decodeNormal(com.swemel.sevenzip.compression.rangecoder.Decoder rangeDecoder) throws IOException {
                int symbol = 1;
                do {
            ...
            public byte decodeWithMatchByte(com.swemel.sevenzip.compression.rangecoder.Decoder rangeDecoder, byte matchByte) throws IOException {
                int symbol = 1;
                do {
    ...
    private final com.swemel.sevenzip.compression.rangecoder.Decoder m_RangeDecoder = new com.swemel.sevenzip.compression.rangecoder.Decoder();
    ...
    void init() throws IOException {
        ...
        com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsMatchDecoders);
        com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRep0LongDecoders);
        com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepDecoders);
        com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepG0Decoders);
        com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepG1Decoders);
        com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepG2Decoders);
        com.swemel.sevenzip.compression.rangecoder.Decoder.initBitModels(m_PosDecoders);
