...
public class Encoder {
    ...
    void init() {
        ...
        com.swemel.sevenzip.compression.rangecoder.Encoder.initBitModels(_isMatch);
        com.swemel.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRep0Long);
        com.swemel.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRep);
        com.swemel.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRepG0);
        com.swemel.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRepG1);
        com.swemel.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRepG2);
        com.swemel.sevenzip.compression.rangecoder.Encoder.initBitModels(_posEncoders);
    ...
    int getOptimum(int position) throws IOException {
        ...
        while (true) {
            ...
            int curAnd1Price = curPrice +
                    com.swemel.sevenzip.compression.rangecoder.Encoder.getPrice0(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]) +
            ...
            matchPrice = curPrice + com.swemel.sevenzip.compression.rangecoder.Encoder.getPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
            ...
            if (!nextIsChar && matchByte != currentByte) {
                ...
                if (lenTest2 >= 2) {
                    ...
                    int nextRepMatchPrice = curAnd1Price +
                            com.swemel.sevenzip.compression.rangecoder.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                    ...
                    if (lenTest2 >= 2) {
                        ...
                        int curAndLenCharPrice =
                                repMatchPrice + getRepPrice(repIndex, lenTest, state, posState) +
                                        com.swemel.sevenzip.compression.rangecoder.Encoder.getPrice0(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                        ...
                        int nextMatchPrice = curAndLenCharPrice + com.swemel.sevenzip.compression.rangecoder.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]);
